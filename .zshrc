...
function nmap-scan-upd(){
	nmap --top-ports 500 -sU -n -v $1 -oG allPortsUdp
	ports="$(cat allPortsUdp | /usr/bin/grep -oP '\d{1,5}/open' | awk '{print $1}' FS='/' | xargs | tr ' ' ',')"
	nmap -p$ports -sCV $1 -oN targetedUdp
}
